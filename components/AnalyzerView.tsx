...
const HeroSection: React.FC<{ language: Language }> = ({ language }) => {
...
const AnalyzerView: React.FC = () => {
  ...
  return (
    <div className="animate-fade-in">
      ...
      {!fileData && <HeroSection language={language} />}
      ...
      {error && (
        <div className="mt-8 p-6 bg-red-50 border border-red-200 rounded-xl text-center shadow-sm animate-fade-in">
          ...
          <p className="text-red-800 font-semibold mb-1 text-lg">{t.analysisFailed}</p>
